...
(function() { return; // ⛔ superseded by the dictionary-driven i18n engine appended at end of file
    var TRANSLATIONS = {
        en: {
            ...
            'setting-cam-label': 'Camera Permission',
            'setting-cam-sub': 'Required for video calls',
        ...
        bn: {
            ...
            'setting-cam-label': 'Camera Permission',
            'setting-cam-sub': 'ভিডিও কলে দরকার',
    ...
    var I18N_MAP = [
        ...
        { key: 'setting-cam-label',     sel: '.si-cam .settings-item-label',         prop: 'innerHTML' },
        { key: 'setting-cam-sub',       sel: '.si-cam .settings-item-sub',           prop: 'innerHTML' },
